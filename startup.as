	...
	; Compiler options:
	;
	; -oonoff_12V.cof -monoff_12V.map --summary=default --output=default \
	; onoff.p1 --chip=12F675 -P --runtime=default \
	; --opt=default,+asm,-debug,-speed,+space,9 --warn=0 --addrqual=ignore \
	; -D_LEGACY_HEADERS -g --asmlist --errformat=Error   [%n] %f; %l.%c %s \
